...
public class S3Sample {
    ...
    public void WritetoS3Bucket(String bucketName, S3Object item) throws IOException {
		...
		*/
        ...
        try {
            s3.putObject(new PutObjectRequest(bucketName, key, item.getObjectContent(), item.getObjectMetadata()));
